import unittest
from linkedlist2_with_dummies import LinkedList2
from linkedlist2_with_dummies import Node
...
class MyTestCase(unittest.TestCase):
    ...
    def test_delete_one(self):
        ...
        self.assertEqual(ll.head.value, "This is error. You shouldn't see this, it's a dummy node.")
        self.assertEqual(ll.tail.value, "This is error. You shouldn't see this, it's a dummy node.")
